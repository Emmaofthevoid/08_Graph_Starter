...
public class ListGraph implements Graph {
	...
	private boolean directed; //gerichtet
	...
	public void addEdge(int v1, int v2, int weight) { //v1 u. v2 sind indexes
		graph[v1].add(new WeightedEdge(v1, v2, weight)); // erste position addieren, das wird sowieso gemacht, egal ob gerichtet oder ungerichtet
		if (!directed) {
			graph[v2].add(new WeightedEdge(v2, v1, weight)); // das passiert extra nur wenns ungerichtet ist
		}
	}
